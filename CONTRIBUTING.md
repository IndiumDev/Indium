Contributing to INDIUM Core
============================

The INDIUM Core project operates an open contributor model where anyone is
...
The following applies to code changes to the INDIUM Core project, and is not to be
confused with overall INDIUM Network Protocol consensus changes.

Whether a pull request is merged into INDIUM Core rests with the project merge
...
Patches that change INDIUM consensus rules are considerably more involved than
...
Where a patch set proposes to change the INDIUM consensus, it must have been
...
The project leader is the release manager for each INDIUM Core release.
