...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 9933;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Indium starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 300; // Indium: 5 minutes
        nTargetSpacing = 1 * 300;  // Indium: 5 minutes
        nMaturity = 100;
        nMasternodeCountDrift = 20;
        nMaxMoneyOut = 15000000 * COIN; // Indium Max Supply 15M = 15,000,000 IDU

        /** Height or Time Based Activations **/
        nLastPOWBlock = 750;
        nModifierUpdateBlock = 9999999999;
        nZerocoinStartHeight = 751;
        nZerocoinStartTime = 1526774400; // Sunday, 20 May 2018 00:00:00
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Don't work for weekends, work for our goals - 1/June/2018.";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1526891401;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 1527811200;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("000006a9d48d35d97a4d3782f40e2ec77142027e75702d40ce2b3dd0ccba1c1a"));
        assert(genesis.hashMerkleRoot == uint256("3e813af7115d1b5b8ff4d1de268e5a0644d35b85e13e9b4274a4839bc0765f8a"));

        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "indium.seed.fuzzbawls.pw"));     // Primary DNS Seeder from Fuzzbawls
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "indium.seed2.fuzzbawls.pw"));    // Secondary DNS Seeder from Fuzzbawls
        vSeeds.push_back(CDNSSeedData("coin-server.com", "coin-server.com"));         // Single node address
        vSeeds.push_back(CDNSSeedData("s3v3nh4cks.ddns.net", "s3v3nh4cks.ddns.net")); // Single node address
        vSeeds.push_back(CDNSSeedData("178.254.23.111", "178.254.23.111"));           // Single node address

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 69); // U or V
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 104); // i or j
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // INDIUM: 1 day
        nTargetSpacing = 1 * 60;  // INDIUM: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "indium-testnet.seed.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "indium-testnet.seed2.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("s3v3nh4cks.ddns.net", "s3v3nh4cks.ddns.net"));
        vSeeds.push_back(CDNSSeedData("88.198.192.110", "88.198.192.110"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet indium addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet indium script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet indium BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet indium BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet indium BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // INDIUM: 1 day
        nTargetSpacing = 1 * 60;        // INDIUM: 1 minutes
