...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* INDIUM features */
        {"indium", "masternode", &masternode, true, true, false},
        {"indium", "listmasternodes", &listmasternodes, true, true, false},
        {"indium", "getmasternodecount", &getmasternodecount, true, true, false},
        {"indium", "masternodeconnect", &masternodeconnect, true, true, false},
        {"indium", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"indium", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"indium", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"indium", "masternodecurrent", &masternodecurrent, true, true, false},
        {"indium", "masternodedebug", &masternodedebug, true, true, false},
        {"indium", "startmasternode", &startmasternode, true, true, false},
        {"indium", "createmasternodekey", &createmasternodekey, true, true, false},
        {"indium", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"indium", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"indium", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"indium", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"indium", "getmasternodescores", &getmasternodescores, true, true, false},
        {"indium", "mnbudget", &mnbudget, true, true, false},
        {"indium", "preparebudget", &preparebudget, true, true, false},
        {"indium", "submitbudget", &submitbudget, true, true, false},
        {"indium", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"indium", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"indium", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"indium", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"indium", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"indium", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"indium", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"indium", "checkbudgets", &checkbudgets, true, true, false},
        {"indium", "mnsync", &mnsync, true, true, false},
        {"indium", "spork", &spork, true, true, false},
        {"indium", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> indium-cli " + methodname + " " + args + "\n";
}
