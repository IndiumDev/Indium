...
/* Indium GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "INDIUM"
#define QAPP_ORG_DOMAIN "indium.org"
#define QAPP_APP_NAME_DEFAULT "INDIUM-Qt"
#define QAPP_APP_NAME_TESTNET "INDIUM-Qt-testnet"
