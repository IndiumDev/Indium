                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("INDIUM Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a INDIUM address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and indium: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About INDIUM Core"), this);
    aboutAction->setStatusTip(tr("Show information about INDIUM Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for INDIUM"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your INDIUM addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified INDIUM addresses"));
    ...
    openAction->setStatusTip(tr("Open a INDIUM: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the INDIUM Core help message to get a list with possible INDIUM command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("INDIUM Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to INDIUM network", "", count));
}
...
{
    QString strTitle = tr("INDIUM Core"); // default title
