...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case IDU:
        return QString("indium");
    case mPIV:
        return QString("mIndium");
    case uPIV:
        return QString::fromUtf8("uIndium");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case IDU:
            return QString("IDU");
        case mPIV:
            return QString("Milli-IDU (1 / 1" THIN_SP_UTF8 "000)");
        case uPIV:
            return QString("Micro-IDU (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
