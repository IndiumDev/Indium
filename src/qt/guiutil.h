...
/** Utility functions used by the INDIUM Qt UI.
 */
namespace GUIUtil
{
...
// Render INDIUM addresses in monospace font
...
// Parse "indium:" URI into recipient object, return true on successful parsing
