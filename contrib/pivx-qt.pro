...
RESOURCES += src/qt/indium.qrc src/qt/indium_locale.qrc

TRANSLATIONS += src/qt/locale/Indium_bg.ts \
                src/qt/locale/Indium_de.ts \
                src/qt/locale/Indium_en.ts \
                src/qt/locale/Indium_es.ts \
                src/qt/locale/Indium_fi.ts \
                src/qt/locale/Indium_fr.ts \
                src/qt/locale/Indium_it.ts \
                src/qt/locale/Indium_ja.ts \
                src/qt/locale/Indium_pl.ts \
                src/qt/locale/Indium_pt.ts \
                src/qt/locale/Indium_ru.ts \
                src/qt/locale/Indium_sk.ts \
                src/qt/locale/Indium_sv.ts \
                src/qt/locale/Indium_vi.ts \
                src/qt/locale/Indium_zh_CN.ts \
                src/qt/locale/Indium_zh_TW.ts
