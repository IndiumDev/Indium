...
This means one can have an always-on Indiumd instance running, and another local Indiumd/indium-qt instance which connects to this node and receives blocks from it.
