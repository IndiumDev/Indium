...
This mechanism has been integrated into Bitcore-Node-INDIUM which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/INDIUM-Project/insight-api-indium#web-socket-api](https://github.com/INDIUM-Project/insight-api-indium#web-socket-api) 
* API: [https://github.com/INDIUM-Project/insight-api-indium#swifttx-transactions](https://github.com/INDIUM-Project/insight-api-indium#swifttx-transactions) 
...
By default, the INDIUM Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the INDIUM Core daemon:
