...
In order to support loading of multiple wallets in indium-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is indium.cpp.
...
Changes to indium.cpp
----------------------
indium.cpp is the entry point into indium-qt, and as such, will require some minor modifications to provide hooks for
